/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: ee281d68e1faf34ccc00f1461964c467)
...
declare namespace Cloudflare {
	...
	interface Env {
		MY_VAR: "Hello from Cloudflare Dev" | "Hello from Cloudflare Stage" | "Hello from Cloudflare Prod";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "CLOUDFLARE_ENV" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
