			...
			<main className="flex-1 px-6 py-16 w-full">
				...
				<div className="prose prose-zinc dark:prose-invert max-w-none space-y-8">
					<div className="space-y-2">
						<p className="text-sm">
							<strong>{t("cookiePolicy.companyNameLabel")}</strong> {t("cookiePolicy.companyName")}
						</p>
						<p className="text-sm">
							<strong>{t("cookiePolicy.policyOwnerLabel")}</strong> {t("cookiePolicy.policyOwner")}
						</p>
						<p className="text-sm">
							<strong>{t("cookiePolicy.effectiveDateLabel")}</strong>{" "}
						...
						<div className="ml-6 mt-6 space-y-4">
							...
							<div>
								...
								<p className="text-muted-foreground">
									{t("cookiePolicy.strictlyNecessary.content")}
								</p>
							</div>
