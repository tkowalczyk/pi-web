/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv --env dev` (hash: f53609b95e2feebba9069b3340f35be0)
// Runtime types generated with workerd@1.20260128.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		CLOUDFLARE_ENV_STAGE_ADDRESS: string;
		CLOUDFLARE_ENV_PROD_ADDRESS: string;
		DATABASE_HOST: string;
		DATABASE_USERNAME: string;
		DATABASE_PASSWORD: string;
		SERWERSMS_API_TOKEN: string;
		SERWERSMS_SENDER_NAME: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_CARD_MONTHLY_PRICE_ID: string;
		STRIPE_BLIK_ANNUAL_PRICE_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "CLOUDFLARE_ENV_STAGE_ADDRESS" | "CLOUDFLARE_ENV_PROD_ADDRESS" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "SERWERSMS_API_TOKEN" | "SERWERSMS_SENDER_NAME" | "STRIPE_SECRET_KEY" | "STRIPE_CARD_MONTHLY_PRICE_ID" | "STRIPE_BLIK_ANNUAL_PRICE_ID" | "STRIPE_WEBHOOK_SECRET">> {}
}
