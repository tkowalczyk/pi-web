...
ALTER TABLE "households" ADD COLUMN "timezone" text DEFAULT 'Europe/Warsaw' NOT NULL;--> statement-breakpoint
ALTER TABLE "notification_sources" ADD COLUMN "topic_id" integer;